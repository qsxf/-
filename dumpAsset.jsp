...
<div style="margin-top: 10px;" class="layui-form">
    ...
    <div class="layui-inline">
        ...
        <div class="layui-input-inline">
            <input type="tel"  id="param" autocomplete="off" class="layui-input" style="width: 211px" placeholder="请输入资产编号或资产名称">
        </div>
    </div>
...
<div class="layui-inline">
    ...
    <div >
        <button type="button" class="layui-btn layui-btn-danger" data-type='delbut' id="but1"> <i class="layui-icon"></i>删除</button>
...
<script src="../js/dumpAsset/dumpAsset.js"></script>
<script>
...
<script type="text/html" id="ckjob">
    ...
    <a href="javascript:;" class="layui-btn layui-btn-sm" id="edit"  lay-event="edit">{{ '编辑' }}</a>
</script>
<script>
    $(function(){
        $("#edit").click(function(){
            $(window).attr('location',"../view/dumpAsset/addDumpAsset.html");
        });
    });
